              ...
              <table className="w-full border-collapse">
                <tbody>
                  <tr className="border-b border-gray-200">
                    <th className="py-4 px-6 text-left bg-yellow-50 w-1/3 font-bold">法人名</th>
                    <td className="py-4 px-6 text-black">株式会社PINZORO</td>
                  </tr>
                  <tr className="border-b border-gray-200">
                    <th className="py-4 px-6 text-left bg-yellow-50 w-1/3 font-bold">代表取締役</th>
                    <td className="py-4 px-6 text-black">近藤 大貴</td>
                  </tr>
                  <tr className="border-b border-gray-200">
                    <th className="py-4 px-6 text-left bg-yellow-50 w-1/3 font-bold">本店住所</th>
                    <td className="py-4 px-6 text-black">東京都江戸川区平井六丁目37番1号</td>
                  </tr>
                  <tr className="border-b border-gray-200">
                    <th className="py-4 px-6 text-left bg-yellow-50 w-1/3 font-bold">会社設立</th>
                    <td className="py-4 px-6 text-black">平成29年4月21日</td>
                  </tr>
                  <tr className="border-b border-gray-200">
                    <th className="py-4 px-6 text-left bg-yellow-50 w-1/3 font-bold">資本金</th>
                    <td className="py-4 px-6 text-black">5,000,000円</td>
                  </tr>
                  <tr className="border-b border-gray-200">
                    <th className="py-4 px-6 text-left bg-yellow-50 w-1/3 font-bold">主な事業</th>
                    <td className="py-4 px-6 text-black">飲食店の経営、企画及び管理</td>
                  </tr>
                  <tr>
                    <th className="py-4 px-6 text-left bg-yellow-50 w-1/3 font-bold">店舗数</th>
